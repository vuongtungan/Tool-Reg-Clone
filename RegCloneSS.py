...
def grant(package, permission,device):
    cmd = "pm grant --user 96 " + package + permission
    return device.shell(cmd)

def install_dual():
    return subprocess.run('adb install --user 96 apps/base.apk')
...
def NoxregFacebook(i):
    ...
    click_ocr('dual_app.PNG',device)

    time.sleep(12)

    click_ocr('image/real/continue.PNG', device)
    time.sleep(1)

    print("Nhấn Tạo tài khoản...")
    click_ocr("image/real/create.PNG",device)

    time.sleep(5)
    print("Nhấn Next...")
    click_ocr("image/real/next.PNG",device)
    time.sleep(2)
    ...
    click_ocr('image/real/hide.PNG',device)
    time.sleep(0.5)
    ...
    click_ocr("image/real/ok.PNG",device)

    time.sleep(2)
    print("Điền giới tính")
    click_ocr("image/real/gender.PNG",device)
    time.sleep(random.randint(1,2))
    click_ocr("image/real/next.PNG",device)
    time.sleep(random.randint(1,2))
    ...
    number, id = get_number_VOTP('e1b2f796b07b4a549e4a840e7d9c15af')
    ...
    click_ocr("image/real/regist.PNG",device)
    time.sleep(25)

    click_ocr('image/real/other.PNG',device)
    time.sleep(random.randint(1,2))
    click_ocr('image/real/oke.PNG',device)
    time.sleep(random.randint(1,2))

    while True:
        time.sleep(random.randint(1,2))
        otp = get_otp_VOTP('e1b2f796b07b4a549e4a840e7d9c15af',id)
        if otp != None:
            break
    ...
    click_ocr('image/real/hide.PNG', device)
    time.sleep(0.5)
    click_ocr('image/real/confirm.PNG',device)
    time.sleep(10)
